...
class emails:
    ...
    def __init__(self, root):
        ...
        self.settings_icon = ImageTk.PhotoImage(file="Settings.png")
        title = Label(self.root, text="Send Emails", font=("Goudy Old Style", 48, "bold"), bg="#ADD8E6",
        ...
        description = Label(self.root, text="Attach the excel sheet below", font=("Valibri(Body)", 14), bg="#FFD966",
